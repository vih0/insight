...
import { Conteiner, CloseButton,DeleteButton, ShareButton } from "./ModalStyle";
export function Modal({ setOpen, text, date, color, deleteFunction }) {
  ...
  return (
    <Conteiner background={color} ref={componentRef}>
     ...
     <ShareButton  title="Clique para fazer Download" onClick={handlePrint}><FileArrowDown size={32}/></ShareButton>
    </Conteiner>
  );
}
